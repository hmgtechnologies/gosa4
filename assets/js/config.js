...
window.SCHOOL = {
  ...
  font:    'sourcesanspro',
  layout:  'layout0',
  modules: ["students","staff","classes","subjects","attendance","results","timetable","sow","cbt","cbt-prompts","report-cards","timetable-generator","checkin","assignments","library","digital_library","conduct","health","promotion","lms","gamification","career_counseling","lesson_plans","behaviour","support_plans","substitutions","entrance","storage","analytics","approvals","admin-data","settings","admissions","hr","hostel","alumni","inventory","certificates","document_builder","fleet_tracking","facility_booking","compliance","activity_log","developer","diary","surveys","announcements","events","messages","inbox","complaints","broadcast","voting","parent_meeting","front_desk","helpdesk","menu","gallery","eresources","birthdays","idcards","flyer","reports","directory","departments","parents","school_calendar","lost_found","book_request","fees","finance","leave","visitors","transport","cafeteria","financial_aid","donations","payments_online"],
